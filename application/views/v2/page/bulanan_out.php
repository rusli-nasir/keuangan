    ...
    <div class="col-xs-12">
      <div class="box">
        ...
        <div class="box-body">
          ...
          <p>
            <form style="display:flex;" action="<?php echo base_url('v2/main/bulanan_out') ?>" method="get">
              <div class="input-group" style="position: relative; width: 200px;">
          ...
          <?php } else { ?>
          <button type="button" class="btn btn-success hidden-xs" style="display:flex;margin-bottom: 10px" onclick="goBack()">Kembali</button>
          <?php } ?>
                ...
                <?php $i=1; foreach ($list_harian_out as $row) { ?>
                  <tr>
                    ...
                    <td style="text-align:center;">
                      ...
                      <a class="btn btn-xs btn-danger" onclick="return confirm('Yakin menghapus data ini ?');" href="<?php echo base_url('keuangan/delete_payment_out/'.$row['payid'].'/'.$now) ;?>" title="Delete"><i class="fa fa-remove"></i></a>
                    </td>
                    <?php } ?>
                  </tr>
                <?php } ?>
      ...
      <div class="modal-header">
        ...
        <div class="modal-body form-group">
          <form method="post" action="<?php echo base_url('keuangan/edit_payment_out') ?>">
            ...
            <input type="hidden" name="opsi_bulan" value="bln">
            <div class="row">
