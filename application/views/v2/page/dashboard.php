...
<section class="content">
  ...
  <div class="row">
    ...
    <div class="col-md-3 col-sm-6 col-xs-12">
      <div class="info-box">
        <span class="info-box-icon bg-green"><i class="fa fa-minus-square"></i></span>
    ...
    <div class="col-md-12">
      ...
      <div class="box box-success">
        ...
        <div class="box-body">
          ...
          <p>Mohon menjaga Akun anda secara rahasia, jika ada kendala harap hubungi Admin. (0811 800 22 55)</p>
          <!-- /.row -->
        </div>
        <!-- /.box-body -->
      </div>
