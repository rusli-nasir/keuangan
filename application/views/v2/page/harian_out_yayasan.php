          ...
          <div class="table-responsive">
            <table class="table table-bordered table-striped table-hover">
               <thead>
                ...
                Jumlah (<?php echo number_format($total_harian_out_yayasan, 0 , '' , '.' ) ?>)</th>
                </tr>
              </thead>
              <tbody>
              <?php
              $num = 1;
              foreach ($list_harian_out_yayasan as $row_payment_lainnya) { ?>
                <tr>
                  <td><?php echo $num++ ?></td>
                  ...
                  <td><?php echo number_format($row_payment_lainnya['amount'], 0 , '' , '.' );
                    // if (($current_date == $now) OR empty($now)) {
                      ...
                      <a class="edit" href="<?php echo base_url('keuangan/get_payment_id_lainnya/'.$row_payment_lainnya['id']) ;?>" title="Edit"><i class="fa fa-edit"></i></a>
                      <a class="delete" onclick="return confirm('Yakin menghapus data ini ?');" href="<?php echo base_url('keuangan/delete_payment_out/'.$row_payment_lainnya['id']) ;?>" title="Delete"><i class="fa fa-remove"></i></a>
                  <?php //}
                                    } ?>
                  </td>
                </tr>
  ...
  <div class="modal-dialog modal-md">
    <div class="modal-content">
      <div class="modal-header">
          ...
          <h4 class="modal-title" id="mySmallModalLabel">Pengeluaran</h4>
        </div>
        <form method="post" action="<?php echo base_url().'keuangan/payment_yayasan_out' ?>" class="form-horizontal">
