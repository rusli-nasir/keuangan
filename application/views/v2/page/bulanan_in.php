    ...
    <div class="col-xs-12">
      <div class="box">
        ...
        <div class="box-body">
          ...
          <p>
            <form style="position:absolute; display:flex;" action="<?php echo base_url('v2/main/bulanan_in/'.$data['sekolah_id']) ?>" method="get">
            <a target="_blank" style="width:auto" class="btn btn-warning" href="<?php echo base_url('v2/main/pdf?type=2&id='.$sekolah_id.'&times='.$now.''); ?>">Print</a>
